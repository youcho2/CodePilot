...
const en = {
  ...
  'gallery.searchPlaceholder': 'Search prompt, project, source, model, or method…',
  'gallery.kindAll': 'All',
  'gallery.trash': 'Trash',
  'gallery.activeAssets': 'Assets',
  'gallery.restore': 'Restore',
  'gallery.restoreFailed': 'This Asset could not be restored.',
  'gallery.moveToTrash': 'Move to Trash',
  'gallery.confirmMoveToTrash': 'Move to Trash?',
  'gallery.recoverableDelete': 'The local bytes are retained and can be restored.',
  'gallery.deleteBlocked': 'This Asset is still used by: {consumers}',
  'gallery.trashFailed': 'This Asset could not be moved to Trash.',
  ...
  'gallery.staticWebPreview': 'Archived static web preview',
