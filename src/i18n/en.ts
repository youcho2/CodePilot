...
const en = {
  ...
  'settings.proxyDesc': 'Route all outbound requests (Claude Code, Codex, native providers, logins) through an HTTP(S) proxy. Useful when your network reaches AI providers only via a corporate/egress proxy. Applies on the next message — no restart.',
  'settings.proxyUrlLabel': 'Proxy URL',
  'settings.proxyNoProxyLabel': 'No-proxy hosts (optional)',
  'settings.proxyNoProxyHint': 'Comma-separated hosts/domains that bypass the proxy. localhost and 127.0.0.1 are always excluded automatically.',
  'settings.proxySave': 'Save',
  'settings.proxySaving': 'Saving…',
  'settings.proxySaved': 'Saved',
  'settings.proxyTest': 'Test connection',
  'settings.proxyTesting': 'Testing…',
  'settings.proxyTestOk': 'Proxy reached Anthropic successfully.',
  'settings.proxyTestFail': 'Could not reach Anthropic through this proxy',
