...
const zh: Record<TranslationKey, string> = {
  ...
  'gallery.searchPlaceholder': '搜索提示词、项目、来源、模型或方法…',
  'gallery.kindAll': '全部',
  'gallery.trash': '废纸篓',
  'gallery.activeAssets': '素材',
  'gallery.restore': '恢复',
  'gallery.restoreFailed': '无法恢复这个素材。',
  'gallery.moveToTrash': '移到废纸篓',
  'gallery.confirmMoveToTrash': '确认移到废纸篓？',
  'gallery.recoverableDelete': '本地文件会保留，之后仍可恢复。',
  'gallery.deleteBlocked': '这个素材仍被以下对象使用：{consumers}',
  'gallery.trashFailed': '无法将这个素材移到废纸篓。',
  'gallery.source': '来源',
  'gallery.project': '项目',
  'gallery.method': '方法',
  'gallery.runtime': '运行时',
  ...
  'gallery.staticWebPreview': '已归档的静态网页预览',
