...
const zh: Record<TranslationKey, string> = {
  ...
  'settings.proxyDesc': '让所有出站请求（Claude Code、Codex、原生服务商、登录）都走 HTTP(S) 代理。适用于只能经公司/内网代理出口访问 AI 服务商的网络。保存后下一条消息即生效，无需重启。',
  'settings.proxyUrlLabel': '代理地址',
  'settings.proxyNoProxyLabel': '不走代理的主机（可选）',
  'settings.proxyNoProxyHint': '用逗号分隔的主机/域名，这些不走代理。localhost 和 127.0.0.1 已自动排除。',
  'settings.proxySave': '保存',
  'settings.proxySaving': '保存中…',
  'settings.proxySaved': '已保存',
  'settings.proxyTest': '测试连接',
  'settings.proxyTesting': '测试中…',
  'settings.proxyTestOk': '已成功通过代理连接 Anthropic。',
  'settings.proxyTestFail': '无法通过该代理连接 Anthropic',
