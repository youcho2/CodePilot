...
| Phase 4 | 第一批安全落地能力 | 🚧 进行中 | 2026-07-03 按 phase 自动推进规则启动（issue #8）：timeout 原因码 / approval HMAC / trace 脱敏 / `@ai-sdk/mcp` POC，8 条 required checks 下发；触及 credential/脱敏/权限默认/用户文案即停 |
